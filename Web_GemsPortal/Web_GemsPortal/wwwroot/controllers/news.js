                            ...
                            `<div class="row blog-media">
                                    ...
                                    <div class="blog-left spotlight">
                                        <a href="/tin-tuc/${value.titleSlug}-${value.id}">
                                            <img src="${IsNullOrEmty(value.imageObj?.mediumUrl) ? "/assets/images/error/news.png" : value.imageObj?.mediumUrl}"
                                                 class="img-fluid blur-up lazyload bg-img img_news" loading="lazy" alt="${value.title}"
                                ...
                                <div class="col-xl-6">
                                    <div class="blog-right">
                                        <div>
                                            <h5 class="color-default">${IsNullOrEmty(value.createdAt) ? "" : moment(value.createdAt).format('DD-MM-YYYY')}</h5>
                                            <a href="/tin-tuc/${value.titleSlug}-${value.id}">
                            ...
                            `<li>
                                <a href="/tin-tuc/${value.titleSlug}-${value.id}">
                                    <div class="media mt-2">
                                        <img class="img-fluid blur-up lazyload" loading="lazy" src="${IsNullOrEmty(value.imageObj?.mediumUrl) ? "/assets/images/error/news.png" : value.imageObj?.mediumUrl}" alt="${value.title}" style="height:59px;object-fit:cover;"
                                            onerror="this.onerror=null;this.src='/assets/images/error/news.png';">
                                        <div class="media-body align-self-center">
                                            <h6 class="sp-line-2 fs-6" title="${IsNullOrEmty(value.title) ? "" : value.title}">${IsNullOrEmty(value.title) ? "" : value.title}</h6>
                                            <span class="color-default">${IsNullOrEmty(value.createdAt) ? "" : moment(value.createdAt).format('DD-MM-YYYY')}</span>
                                        </div>
                                    </div>
                                </a>
                            </li>`;
