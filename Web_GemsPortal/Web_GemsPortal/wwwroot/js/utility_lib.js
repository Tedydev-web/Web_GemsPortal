...
const MEMBER_HREF_PATH = 'thanh-vien';
const CERTIFICATE_MEMBER = `<div title="Hội viên GEMS GROUP" hidden style="width: 26px; height: 26px; display: flex; position: absolute; z-index: 1; padding: 0px; right: 4px; background: #ffffff; top: 4px; border-radius: 100%; justify-content: center; align-items: center;">
                                <svg style="width: 20px; height: 20px; fill: #198754;">
...
var _imgNotFoundHtml =
    `<div class="notifica-not-found text-center">
        <img src="/img/notFound.png" alt="No data" />
    </div>`;
...
//var res = arr.filter(DistinctArr);
