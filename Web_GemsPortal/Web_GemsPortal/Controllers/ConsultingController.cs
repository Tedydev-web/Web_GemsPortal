...
{
    public class ConsultingController : BaseController<ConsultingController>
    {
        ...
        public ConsultingController(IS_News news, IS_RegisterCourse registerCourse, IOptions<Config_MetaSEO> metaSEO)
        {
            _s_News = news;
        ...
        public async Task<IActionResult> Index(int? c, int record = 12, int page = 1)
        {
            ...
            SetViewDataSEOExtensionMethod.SetViewDataSEODefaultAll(this, _metaSEO.Value.Consulting);
            return View();
        }
        ...
        {
            ResponseData<List<M_News>> res = await _s_News.getListHubNewsByCategoryIdTypeId(_supplierId, c, EN_NewsCategoryTypeId.Consulting, record, page);
