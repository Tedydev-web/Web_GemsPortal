...
{
    public static class ValidationAttributeExtensionMethod
    {
        ...
        public class MaxFileSizeInListAttribute : ValidationAttribute
        {
            private readonly int _maxFileSize;
            private readonly string _errorMessage;
        ...
        public class AllowedExtensionsInListAttribute : ValidationAttribute
        {
            private readonly string[] _extensions;
            private readonly string _errorMessage;
